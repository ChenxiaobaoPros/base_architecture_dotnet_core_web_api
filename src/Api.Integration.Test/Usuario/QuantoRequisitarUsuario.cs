...
{
    public class QuantoRequisitarUsuario : BaseIntegration
    {
        ...
        public async Task E_Possivel_Realizar_Crud_Usuario()
        {
            ...
            var listaFromJson = JsonConvert.DeserializeObject<IEnumerable<UserDto>>(postResult);
            ...
            postResult = await response.Content.ReadAsStringAsync();
            var registroAtualizado = JsonConvert.DeserializeObject<UserDtoUpdateResult>(postResult);
            ...
            Assert.Equal(HttpStatusCode.OK, response.StatusCode);
            postResult = await response.Content.ReadAsStringAsync();
            var registroSelecionado = JsonConvert.DeserializeObject<UserDto>(postResult);
